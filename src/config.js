...
const namePrefix = "Centro Vaux Ballers Club";
const description = "We are creating a 10k collection in tribute to Koby Bryan, all proceeds of this collection will go to Big Picture Philadelphia";
...
const extraMetadata = {
  external_url: "https://sites.google.com/bigpicturephiladelphia.org/donate/home", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = 'CVBC';
const CONTRACT_SYMBOL = 'CV';
const CONTRACT_TYPE = 'erc721';
const MINT_TO_ADDRESS = '0x3ebCdB2C404e1672b2EC5A5aDF1aa7ECdDC544d7';
const CHAIN = 'rinkeby';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const ROYALTY_SHARE = 100; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0x3ebCdB2C404e1672b2EC5A5aDF1aa7ECdDC544d7"; // Address that will receive the royalty
// ** OPTIONAL **
